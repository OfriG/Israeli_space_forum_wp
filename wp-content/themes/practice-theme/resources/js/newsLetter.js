...
//         init() {
//             console.log('Newsletter init started');
//             console.log('Form found:', this.form.length);
//             console.log('Email input found:', this.emailInput.length);
...
//             if (typeof newsletter_ajax === 'undefined') {
//                 console.error('newsletter_ajax is not defined');
...
//                     nonce: newsletter_ajax.nonce // Security nonce for validation
//                 },
//                 dataType: 'json'
//             })
